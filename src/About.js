      ...
      <div className='container-fluid'>
        <div className='row'>
          ...
          <div className='col' id='selfDescription'>
            <p>I am a Full stack developer, specializing in React, JavaScript, Node JS, Express and MongoDB. I am also an app developer and have an app currently in the Apple App Store.</p>
